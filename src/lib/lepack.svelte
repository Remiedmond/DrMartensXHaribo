...
>
  ...
  <div class="relative z-10 flex flex-col h-full justify-between flex-1 items-start ">
    ...
    <div class="space-y-4 transition-all duration-700 ease-out" 
      ...
      <h2 class="text-6xl md:text-8xl font-black text-black tracking-tighter">
        Le Pack Collector
      </h2>
      <p class="text-xl md:text-3xl font-medium text-black max-w-md leading-tight">
    ...
    <div class="mt-24 md:mt-5 flex flex-col items-start self-end w-full max-w-4xl transition-all duration-1000 delay-300 ease-out"
      ...
      <h3 class="text-3xl md:text-5xl font-black text-black uppercase tracking-tighter mb-8">
        Une collab' inusitée
      </h3>

      <a href="#shop" class="group w-full border-b-2 border-black pb-4 flex justify-between items-end hover:border-haribo-red transition-colors duration-300">
        <span class="text-sm font-bold uppercase tracking-widest text-black group-hover:text-haribo-red">
          découvrir le pack
        </span>
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-black group-hover:text-haribo-red group-hover:-translate-y-1 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
